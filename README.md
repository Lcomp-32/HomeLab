...
Technologies used:
Proxmox: My hypervisor that allows for flexibility with my network and decreases the cost of running labs to near 0.
OPNSense: My firewall.
Windows VMs: My "Users".
Windows Servers: Domain Controllers.
Wazuh: SIEM of choice.

* This list will have additions once the scope of my homelab increases.
